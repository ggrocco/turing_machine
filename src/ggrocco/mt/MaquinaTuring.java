		...
		while(!estadoFinal){
			...
			for(Acao acaoAtual : estados.get(estadoAtual).getAcoes()){
				...
				if(fita.ler() == acaoAtual.getLer()){
					...
					String outSaida = "Estado: " + ( estadoAtual + 1 ) + " Fita: " + fita.toString() + " - A��o: " + acaoAtual;
					printSaida("\n" +  outSaida);					
					...
					// Se o que ja ta na fita � igual ao que iria gravar
					// n�o perde tempo gravando
